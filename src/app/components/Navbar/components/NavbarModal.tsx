...

            {
                ...
                createPortal(
                    <div
                        ...
                        <div className={"relative flex flex-col items-center gap-y-[5px] justify-center sm:absolute sm:top-[150px] sm:text-xl sm:font-medium sm:gap-y-[7px] md:top-[170px]"}>
