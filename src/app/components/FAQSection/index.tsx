        ...
        <section className={"bg-white text-black overflow-hidden"}>
            <div className={"mContainer relative"}>
                ...
                <div className="max-w-3xl mx-auto p-4 pt-[50px] pb-[70px]">
                    <motion.h2
                        className="mb-[33px] font-bold text-[30px] text-[#004040] text-center sm:text-[35px] md:text-[40px] lg:text-[60px] xl:text-[70px] relative"
                    ...
                    >
                        {faqItems.map((item, index) => (
                            <motion.div
                                key={index}
                                className="border-b border-black pb-[10px] relative"
                                initial={{opacity: 0, left: 50, scale: 0.7}}
                                whileInView={{opacity: 1, left: 0, scale: 1}}
                                viewport={{once: true}}
                                transition={{ease: "easeOut", duration: 0.8}}
