            ...
            <div
                ...
                <div className={"mt-[30px] ml-[20px]"}>
                    ...
                    <motion.p
                        ...
                        transition={{duration: 0.7}}
                    >
                        Обладая более чем 10-летним опытом работы в сфере информационных технологий, мы не просто решаем
                        задачи — мы находим оптимальные и эффективные решения для каждого заказчика.
                    </motion.p>
                </div>
            </div>
        </section>
