...
const SectionMain = () => {
    return (
        <section className={"bg-white w-full overflow-hidden relative"}>
            <div className={"mContainer pt-[10px] pb-[40px] items-center relative sm:pt-[20px] sm:pb-[60px] md:pt-[40px] md:pb-[80px] lg:pt-[80px] lg:pb-[130px] xl:pt-[100px] xl:pb-[160px]"}>
                <Image className={"absolute right-[80px] xl:right-[230px] top-0 hidden lg:block"} src={"/assets/location.png"} alt={"Image"} width={397} height={381} />
